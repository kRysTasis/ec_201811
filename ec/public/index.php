	...
	<div id="content-wrap">
		<div class="content">
			...
			<div id="products">
				...
				<form method="post" id="product_form" name="product_form" action="product.php">
					<input type="hidden" id="id_data" name="id_data" value="">
					<ul class="products_list">
						<?php foreach($app->getInfo() as $product) : ?>
							<li class="products_link" data-id="<?= h($product['id']); ?>">
									<img src="../image/<?= h($product['url']) ; ?>">
									<p class="product_collection"><?= h($product['collection']) ?></p>
									<p class="product_name"><?= h($product['name']) ?></p>
